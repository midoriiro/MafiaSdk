...
public static partial class StreamHelpers
{
    ...
    {
        byte[] data = SmallWorkBuffer.Get(1);
        data[0] = value;
    ...
    {
        byte[] data = SmallWorkBuffer.ReadBytes(stream, 2);
    ...
    public static void WriteValueU16(this Stream stream, ushort value, Endian endian)
    {
        ...
        byte[] data = SmallWorkBuffer.Get(2);
    ...
    {
        byte[] data = SmallWorkBuffer.ReadBytes(stream, 4);
    ...
    public static void WriteValueU32(this Stream stream, uint value, Endian endian)
    {
        ...
        byte[] data = SmallWorkBuffer.Get(4);
    ...
    {
        byte[] data = SmallWorkBuffer.ReadBytes(stream, 8);
    ...
    public static void WriteValueU64(this Stream stream, ulong value, Endian endian)
    {
        ...
        byte[] data = SmallWorkBuffer.Get(8);
