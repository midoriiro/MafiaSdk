...
public static class PathHelper
{
    public static string? GetRelativePath(string fromPath, string? toPath)
    {
        ...
        string[] fromDirectories = fromPath.Split(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar);
        string[] toDirectories = toPath.Split(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar);
