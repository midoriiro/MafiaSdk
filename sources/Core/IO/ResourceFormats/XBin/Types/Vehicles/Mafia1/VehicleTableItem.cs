...
namespace Core.IO.ResourceFormats.XBin.Types.Vehicles.Mafia1
{
    public class VehicleTableItem : IVehicleTableItem
    {
        ...
        public float MinDirt { get; init; }
        public float MinRust { get; init; }
        public float MaxDirt { get; init; }
        public float MaxRust { get; init; }
        public EVehicleRaceClass RaceClass { get; init; }
        ...
        public static IVehicleTableItem ReadEntry(BinaryReader reader)
        {
            ...
            float minDirt = reader.ReadSingle();
            float minRust = reader.ReadSingle();
